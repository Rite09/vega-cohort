...
const STEPS = [
  {
    ...
    imageSrc: "/diagonse-img.png",
    imageAlt: "Diagnose process illustration",
  ...
  },
  {
    ...
    imageSrc: "/blueprint-img.png",
    imageAlt: "Blueprint process illustration",
  ...
  },
  {
    ...
    imageSrc: "/result-img.png",
    imageAlt: "Execution results illustration",
    ...
    <article className="overflow-hidden rounded-[34px] border border-[rgba(223,229,239,0.95)] bg-[rgba(255,255,255,0.96)] px-6 py-7 shadow-[0_18px_50px_rgba(20,32,58,0.08)] backdrop-blur-[14px] sm:px-8 sm:py-9 lg:px-10 lg:py-10">
      <div className="grid gap-8 lg:grid-cols-[280px_minmax(0,1fr)] lg:gap-10">
        <div className="relative flex flex-col items-center">
          <div
            className="relative z-10 flex h-[74px] w-[74px] self-start items-center justify-center rounded-full border border-white bg-white shadow-[0_14px_34px_rgba(28,43,75,0.1)]"
            style={{ background: step.badgeBackground }}
          >
            <BadgeIcon variant={step.variant} />
          </div>
          <div className="relative flex w-full justify-center pt-5">
            <div
              aria-hidden="true"
              className="absolute left-1/2 top-[32px] h-[252px] w-[252px] -translate-x-1/2 rounded-full"
        ...
        <div className="grid gap-6 lg:grid-cols-[72px_1px_minmax(0,1fr)] lg:gap-6">
          <div className="flex items-end gap-4 lg:flex-col lg:items-start lg:gap-1">
            <span className="text-[15px] font-semibold tracking-[-0.02em] text-[#8D96A8]">Step</span>
            <span
              className="text-[clamp(3.2rem,4vw,4.15rem)] font-extrabold leading-none tracking-[-0.08em]"
          ...
          <div className="min-w-0">
            <h3 className="text-[clamp(2.15rem,2.75vw,2.6rem)] font-extrabold leading-[1.06] tracking-[-0.05em] text-[#131C2D]">
              {step.title}
            </h3>

            <p className="mt-4 text-[17px] leading-[1.8] font-medium text-[#566176] sm:text-[17px]">
              {step.intro}
            </p>
            ...
            <ul className="mt-6 space-y-3.5">
              {step.bullets.map((bullet) => (
                <li
                  key={`${step.step}-${bullet.text}`}
                  className="flex items-start gap-3.5 text-[17px] leading-[1.8] font-medium text-[#566176]"
                >
                  <span
                  ...
                  />
                  <span>
                    {bullet.lead ? <span className="font-extrabold text-[#273246]">{bullet.lead}</span> : null}
                    {bullet.lead ? " – " : ""}
                    {bullet.text}
                  </span>
                </li>
            ...
            <div className="mt-6 border-t border-[#E5EAF1] pt-5">
              <p className="text-[17px] leading-[1.8] font-medium text-[#566176]">{step.footer}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      <div className="mx-auto max-w-6xl">
        <div className="mb-14 text-center sm:mb-16">
          ...
          <h2 className="mx-auto mt-5 max-w-[980px] text-[52px] font-extrabold leading-[1.02] tracking-[-0.05em] text-[#10192A]">
